...
{{-- Back Button --}}
<div class="mb-3">
    <a href="{{ route('voucher-sales.index') }}" class="btn btn-outline-light btn-sm">
...
<div class="card shadow mb-4 navy-card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="m-0 fw-semibold">
            ...
            Penjualan voucher tanggal {{ \Carbon\Carbon::parse($sale->sale_date)->format('d F Y') }}
        </h6>
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <table class="table table-bordered table-dark mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-info text-dark">{{ $sale->source }}</span>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="col-md-6">
                @php
                    $avgPerTransaction = $sale->total_transactions > 0
                        ? $sale->total_amount / $sale->total_transactions
                        : 0;
                @endphp
                ...
                <table class="table table-bordered table-dark mb-0">
                    ...
                    <tr>
                        ...
                        <td>Rp {{ number_format($avgPerTransaction, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <small>
                    ...
                    Dibuat pada: {{ \Carbon\Carbon::parse($sale->created_at)->format('d M Y H:i:s') }}
                </small>
            </div>
            <div class="col-md-6 text-md-end">
                <small>
                    <i class="far fa-clock me-1"></i>
                    Diperbarui pada: {{ \Carbon\Carbon::parse($sale->updated_at)->format('d M Y H:i:s') }}
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <a href="{{ route('journal-entries.show', $journalEntry->id) }}" class="btn btn-outline-light btn-sm">
...
<div class="card shadow mb-4 navy-card">
    ...
    <div class="card-body d-flex flex-wrap gap-2">
        ...
        <a href="{{ route('voucher-sales.index') }}" class="btn btn-outline-light">
