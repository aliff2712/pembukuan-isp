...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-md-6 text-end">
        <div class="d-flex justify-content-end gap-2">
            ...
            {{-- Delete All --}}
            <form method="POST" action="{{ route('sinkron.pelanggan.delete') }}" class="d-inline" id="form-delete-bulk">
                @csrf
                @method('DELETE')
            ...
            <table class="table table-hover mb-0 align-middle table-dark table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form method="POST" action="{{ route('sinkron.pelanggan.deleteById', $p->id) }}" 
...
document.querySelectorAll('.form-delete-row').forEach(function(form) {
    form.addEventListener('submit', function(e) {
        var nama = form.getAttribute('data-nama') || 'pelanggan ini';
...
document.getElementById('form-delete-bulk').addEventListener('submit', function(e) {
    if (!confirm('Apakah Anda yakin ingin menghapus SEMUA data pelanggan? Tindakan ini tidak dapat dibatalkan.')) {
        e.preventDefault();
    }
});
</script>
