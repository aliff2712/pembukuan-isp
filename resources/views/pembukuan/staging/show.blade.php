                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                @if($paymentStaging->bulan_tagihan)
                                    @php
                                        $bulans = explode(',', $paymentStaging->bulan_tagihan);
                                        $formattedBulans = collect($bulans)->map(function($b) {
                                            try {
                                                return \Carbon\Carbon::parse(trim($b))->translatedFormat('F Y');
                                            } catch (\Exception $e) {
                                                return $b;
                                            }
                                        })->implode(', ');
